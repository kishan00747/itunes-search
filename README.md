...
- Functional Features:
  ...
  - See details of an album with just a click.
  - Category Filter, Release Date Filter.
  - Supports "Favorites" feature and favorites can be viewed using the filters bar.
  - Add albums to a Queue and view the queue in a clean drawer UI.
...
- Non-functional Features:
  ...
  - Uses Redux with Reselect and has a fully optimised store.
  - Lazy Loads Images for better performance
  - Uses CSS Variables and Fluid typography for beautiful handling of dynamic CSS.
  - Uses Intersection Observer to deliver smooth and intelligent animations on scroll.
  - Built for extensibility and contains reusable components.
